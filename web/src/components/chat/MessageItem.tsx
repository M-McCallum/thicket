...
import { useHasPermission, usePermissionStore } from '@/stores/permissionStore'
import { PermManageMessages } from '@/types/permissions'
import { pins as pinsApi, threads as threadsApi } from '@/services/api'
...
export default function MessageItem({ message, isOwn }: MessageItemProps) {
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = (e: MouseEvent) => {
      ...
      // Only close if mouse left the message entirely (not into the picker)

...
const CLIENT_ID = import.meta.env.VITE_OIDC_CLIENT_ID || 'thicket-web'
const REDIRECT_URI = import.meta.env.VITE_OIDC_REDIRECT_URI || 'http://localhost:5173/auth/callback'
